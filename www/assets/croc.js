...
Croco.prototype = {
	...
	,init: function() {
		...
		console.log("App.hx:110:","hello croquis last");
	}
...
Main.__name__ = true;
Main.main = function() {
	console.log("Main.hx:6:","Hello, world!");
	new App();
};
Math.__name__ = true;
var Std = function() { };
...
var interact_NoteType = { __ename__ : true, __constructs__ : ["Simple"] };
...
interact_Keynote.prototype = {
	onTime: function(s) {
		console.log("interact/KeyNote.hx:19:","onTime");
	...
	,note: function(msg,noteType) {
		this.display(msg,interact_NoteType.Simple);
	}
	,display: function(msg,noteType) {
		console.log("interact/KeyNote.hx:30:","display");
		...
		var txt = window.document.createElement("p");
		interact_Keynote.lay.appendChild(txt);
		txt.innerHTML = msg;
