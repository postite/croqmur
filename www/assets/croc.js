...
croqmur_Croq.prototype = {
	...
	,move: function(x,y,press,buttons) {
		...
		if(buttons == 3) {
			...
			if(this._state != s) {
				...
				haxe_Log.trace("mzlength=" + this.mz.length,{ fileName : "src/croqmur/Croq.hx", lineNumber : 103, className : "croqmur.Croq", methodName : "state"});
	...
	,doolMz: function() {
		haxe_Log.trace("dool " + Std.string(this.memoz),{ fileName : "src/croqmur/Croq.hx", lineNumber : 83, className : "croqmur.Croq", methodName : "doolMz"});
		this.waz = false;
	...
	,wazBut: function() {
		this.waz = true;
		haxe_Log.trace("wasBut",{ fileName : "src/croqmur/Croq.hx", lineNumber : 96, className : "croqmur.Croq", methodName : "wazBut"});
	}
	,state: function(s) {
		if(this._state != s) {
			if(s == croqmur_DroState.Norm) {
